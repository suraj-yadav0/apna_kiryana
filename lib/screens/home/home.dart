    ...
    return Scaffold(
      body: isLoading ? Center(
        ...
        child: Column(
          ...
          categoriesList.isEmpty ? const Center(child: Text("The Category List is Empty."),) : SingleChildScrollView(
         ...
         bestProductsList.isEmpty ? const Center(child: Text("The Product List is Empty"),)  :  Padding(
              padding: const EdgeInsets.all(12.0),
              child: Expanded(
